import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,e}from"./app-5b8fcc1f.js";const p="/cookbook/assets/image-2-edfb2beb.png",l="/cookbook/assets/image-3-284da396.png",o="/cookbook/assets/image-4-76d87d06.png",t="/cookbook/assets/image-5-b69347c2.png",i="/cookbook/assets/image-8c3f9f8c.png",c="/cookbook/assets/image-1-c2912e56.png",d={},r=e(`<h1 id="docker安装oracle并配置" tabindex="-1"><a class="header-anchor" href="#docker安装oracle并配置" aria-hidden="true">#</a> Docker安装oracle并配置</h1><p>本文档记录了使用docker安装oracle 19c，并进行数据库基础配置、使用dmp进行数据库克隆配置的流程。</p><h2 id="_1-docker安装oracle" tabindex="-1"><a class="header-anchor" href="#_1-docker安装oracle" aria-hidden="true">#</a> 1. Docker安装oracle</h2><h3 id="一、获取镜像" tabindex="-1"><a class="header-anchor" href="#一、获取镜像" aria-hidden="true">#</a> 一、获取镜像</h3><p>使用docker搜索oracle对应版本镜像拉取，网上很多的oracle镜像没有文档说明，因此这里做了安装和配置的步骤和说明~</p><ul><li>oracle-11g</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull registry.cn-hangzhou.aliyuncs.com/wifiliu/oracle:11g
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用docker 客户端可以在containers中直接点击查看镜像实例的运行情况和详细信息~<br><img src="`+p+'" alt="Alt text" loading="lazy"></p><p>第一次创建容器实例时，oracle数据库需要进行初始化，在logs中会有日志显示，等待初始化完成之后才可以进行使用。<br><img src="'+l+`" alt="Alt text" loading="lazy"></p><h3 id="三、配置oracle-sid" tabindex="-1"><a class="header-anchor" href="#三、配置oracle-sid" aria-hidden="true">#</a> 三、配置ORACLE_SID</h3><p>使用sqlplus的nolog方式登录服务器遇到ORA-12162报错，一般是因为没有配置ORACLE_SID这个环境变量导致。</p><p>启动oracle后，我们使用sqlplus登录服务器，</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code>sh<span class="token operator">-</span><span class="token number">4.2</span>$ sqlplus <span class="token operator">/</span>nolog
