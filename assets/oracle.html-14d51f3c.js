import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,e}from"./app-795fbe66.js";const p="/cookbook/assets/image-2-edfb2beb.png",l="/cookbook/assets/image-3-284da396.png",o="/cookbook/assets/image-4-76d87d06.png",t="/cookbook/assets/image-5-b69347c2.png",i="/cookbook/assets/image-8c3f9f8c.png",c="/cookbook/assets/image-1-c2912e56.png",d={},r=e(`<h1 id="docker安装oracle并配置" tabindex="-1"><a class="header-anchor" href="#docker安装oracle并配置" aria-hidden="true">#</a> Docker安装oracle并配置</h1><p>本文档记录了使用docker安装oracle 19c，并进行数据库基础配置、使用dmp进行数据库克隆配置的流程。</p><h2 id="_1-docker安装oracle" tabindex="-1"><a class="header-anchor" href="#_1-docker安装oracle" aria-hidden="true">#</a> 1. Docker安装oracle</h2><h3 id="一、获取镜像" tabindex="-1"><a class="header-anchor" href="#一、获取镜像" aria-hidden="true">#</a> 一、获取镜像</h3><p>使用docker搜索oracle对应版本镜像拉取，网上很多的oracle镜像没有文档说明，因此这里做了安装和配置的步骤和说明~</p><ul><li>oracle-11g</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull registry.cn-hangzhou.aliyuncs.com/wifiliu/oracle:11g
