import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,e}from"./app-248f40bc.js";const p="/cookbook/assets/image-2-edfb2beb.png",l="/cookbook/assets/image-3-284da396.png",o="/cookbook/assets/image-4-76d87d06.png",t="/cookbook/assets/image-5-b69347c2.png",i="/cookbook/assets/image-8c3f9f8c.png",c="/cookbook/assets/image-1-c2912e56.png",d={},r=e(`<h1 id="docker安装oracle并配置" tabindex="-1"><a class="header-anchor" href="#docker安装oracle并配置" aria-hidden="true">#</a> Docker安装oracle并配置</h1><p>本文档记录了使用docker安装oracle 19c，并进行数据库基础配置、使用dmp进行数据库克隆配置的流程。</p><h1 id="docker安装oracle" tabindex="-1"><a class="header-anchor" href="#docker安装oracle" aria-hidden="true">#</a> Docker安装oracle</h1><h2 id="一、获取镜像" tabindex="-1"><a class="header-anchor" href="#一、获取镜像" aria-hidden="true">#</a> 一、获取镜像</h2><p>使用docker搜索oracle对应版本镜像拉取，网上很多的oracle镜像没有文档说明，因此这里做了安装和配置的步骤和说明~</p><ul><li>oracle-11g</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull registry.cn-hangzhou.aliyuncs.com/wifiliu/oracle:11g
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="二、启动镜像" tabindex="-1"><a class="header-anchor" href="#二、启动镜像" aria-hidden="true">#</a> 二、启动镜像</h2><p>启动命令：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#11g</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用docker 客户端可以在containers中直接点击查看镜像实例的运行情况和详细信息~<br><img src="`+p+'" alt="Alt text" loading="lazy"></p><p>第一次创建容器实例时，oracle数据库需要进行初始化，在logs中会有日志显示，等待初始化完成之后才可以进行使用。<br><img src="'+l+`" alt="Alt text" loading="lazy"></p><h2 id="三、配置oracle-sid" tabindex="-1"><a class="header-anchor" href="#三、配置oracle-sid" aria-hidden="true">#</a> 三、配置ORACLE_SID</h2><p>使用sqlplus的nolog方式登录服务器遇到ORA-12162报错，一般是因为没有配置ORACLE_SID这个环境变量导致。</p><p>启动oracle后，我们使用sqlplus登录服务器，</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code>sh<span class="token operator">-</span><span class="token number">4.2</span>$ sqlplus <span class="token operator">/</span>nolog
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="创建pdb" tabindex="-1"><a class="header-anchor" href="#创建pdb" aria-hidden="true">#</a> 创建PDB</h1><p>PDB(pluggable database)是可插拔数据库，也就是我们使用的实例，下面我们创建PDB。</p><h2 id="从seed库克隆创建" tabindex="-1"><a class="header-anchor" href="#从seed库克隆创建" aria-hidden="true">#</a> 从seed库克隆创建</h2><p>oracle数据库安装后一般情况下会带有一个PDB#SEED的数据库，这个数据库的状态是READ ONLY的，我们创建PDB时，一般使用seed来进行pdb的创建</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SQL</span><span class="token operator">&gt;</span> <span class="token keyword">show</span> pdbs<span class="token punctuation">;</span>
...
<span class="token comment">------------------------------</span>
EPTEST
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="从非seed库克隆创建" tabindex="-1"><a class="header-anchor" href="#从非seed库克隆创建" aria-hidden="true">#</a> 从非SEED库克隆创建</h2><p>我们也可以从已经存在的非seed库进行克隆:</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">CREATE</span> PLUGGABLE <span class="token keyword">DATABASE</span> <span class="token punctuation">[</span>databaseName<span class="token punctuation">]</span> <span class="token keyword">FROM</span> <span class="token punctuation">[</span>oldDatabaseName<span class="token punctuation">]</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="修改配置文件" tabindex="-1"><a class="header-anchor" href="#修改配置文件" aria-hidden="true">#</a> 修改配置文件</h2><p>创建好pdb数据库后，还需要修改对应的配置文件<code>tnsnames.ora</code>,该文件一般在$ORACLE_HOME/network/admin/ 文件夹下，直接在文件后面添加如下配置即可<br> 如果不进行配置文件修改，在使用账号密码登录PDB数据库时会遇到ORA-12154的报错：<br><code>ORA-12154: TNS:could not resolve the connect identifier specified</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>PS C:<span class="token punctuation">\\</span>Users<span class="token punctuation">\\</span>liuwenfei<span class="token operator">&gt;</span> <span class="token function">docker</span> <span class="token builtin class-name">exec</span> <span class="token parameter variable">-it</span> oracle_19c /bin/bash
...
PDB_NAME <span class="token operator">=</span>
  <span class="token punctuation">(</span>DESCRIPTION <span class="token operator">=</span>
    ...
    <span class="token punctuation">)</span>
  <span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="拔出和插入pdb" tabindex="-1"><a class="header-anchor" href="#拔出和插入pdb" aria-hidden="true">#</a> 拔出和插入PDB</h2><h3 id="拔出pdb" tabindex="-1"><a class="header-anchor" href="#拔出pdb" aria-hidden="true">#</a> 拔出PDB</h3><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">--1.关闭PDB数据库</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意：</p><ol><li><p>被拔出的PDB只能被删除,不能做其它操作,例如mount,打开等,删除之后我们仍然可以再插入.</p></li><li><p>拔出PDB的时候需要指定xml位置,xml中记录了PDB的信息,例如数据文件目录,DBID,PDB参数等等</p></li></ol><h3 id="插入pdb" tabindex="-1"><a class="header-anchor" href="#插入pdb" aria-hidden="true">#</a> 插入PDB</h3><p>插入PDB使用create pluggable database指定xml位置操作：</p><p>一、拔出的PDB再进行插入：</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SQL</span><span class="token operator">&gt;</span> <span class="token keyword">create</span> pluggable <span class="token keyword">database</span> <span class="token punctuation">[</span>databaseName<span class="token punctuation">]</span> <span class="token keyword">using</span> <span class="token string">&#39;/home/oracle/testpdb4.xml&#39;</span> nocopy<span class="token punctuation">;</span>   
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>drop命令：<br> 如果使用了including datafiles则会将数据文件一起删除.<br> 使用keep datafiles会保留数据文件,默认如果不添加参数即为keep datafiles,但是注意keep datafiles则必须先将PDB拔出,所以一般是用在拔出和插入PDB场景下.</li></ul><h1 id="创建用户" tabindex="-1"><a class="header-anchor" href="#创建用户" aria-hidden="true">#</a> 创建用户</h1><p>我们使用sqlplus默认登录之后，链接进入的是CDB，在这个session中，我们只能创建common user，直接执行create user命令一般会遇到ORA-65096这个错误：<br><code>ORA-65096: invalid common user or role name</code><br> 这是因为在CDB层我们只能创建common user ，要创建实例数据库用户需要在相对应的PDB会话中。</p><h2 id="创建用户-1" tabindex="-1"><a class="header-anchor" href="#创建用户-1" aria-hidden="true">#</a> 创建用户</h2><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SQL</span><span class="token operator">&gt;</span> <span class="token keyword">show</span> con_name<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+c+`" alt="创建后C##用户会在PDB中自动创建" tabindex="0" loading="lazy"><figcaption>创建后C##用户会在PDB中自动创建</figcaption></figure><h2 id="查询版本和切换pdb" tabindex="-1"><a class="header-anchor" href="#查询版本和切换pdb" aria-hidden="true">#</a> 查询版本和切换pdb</h2><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">--查询当前版本</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="创建表空间" tabindex="-1"><a class="header-anchor" href="#创建表空间" aria-hidden="true">#</a> 创建表空间</h1><p>oracle中的表空间是数据库级别下的一个空间概念，我们创建的用户和表都需要处在一个表空间中才行，因此一般创建数据库之后，需要给这个数据库创建一个表空间，用来作为我们创建scheme(user)的空间</p><ul><li>创建表空间的sql语法：</li></ul><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">--建立临时表空间</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="用户" tabindex="-1"><a class="header-anchor" href="#用户" aria-hidden="true">#</a> 用户</h1><h2 id="创建普通用户" tabindex="-1"><a class="header-anchor" href="#创建普通用户" aria-hidden="true">#</a> 创建普通用户</h2><p>切换到对应的pdb数据库之后，就可以创建对应的pdb中的普通用户啦</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="使用impdp-expdp" tabindex="-1"><a class="header-anchor" href="#使用impdp-expdp" aria-hidden="true">#</a> 使用impdp/expdp</h1><p>impdp/expdp和sqlplus一样，是oracle服务提供的cmd命令，用来进行数据库的导入、导出。</p><h2 id="文件夹" tabindex="-1"><a class="header-anchor" href="#文件夹" aria-hidden="true">#</a> 文件夹</h2><p>在导入导出中一般会使用到directory文件夹，这个是在sqlplus进入对应的数据库中，创建指定的文件夹变量;<br> 如果某个数据库中没有对应的directory变量，而在导入导出命令中使用，则会导致执行失败。</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">--进入指定的PDB数据库</span>
<span class="token keyword">SQL</span><span class="token operator">&gt;</span> <span class="token keyword">alter</span> <span class="token keyword">session</span> <span class="token keyword">set</span> container<span class="token operator">=</span>EPTEST<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="expdp导出" tabindex="-1"><a class="header-anchor" href="#expdp导出" aria-hidden="true">#</a> expdp导出</h2><p>我们在服务端可以使用expdp导出dmp文件（不需要进入sqlplus，impdp/expdp和sqlplus一样是cmd命令），主要的命令是：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
